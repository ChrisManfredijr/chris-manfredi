...
function Projects() {
    const projectArray = [
        ...
        },
        {
            ...
            tech: ['React', 'Express', 'Node', 'MongoDB', 'Last.FM API', 'GraphQL', 'React Bootstrap'],
        ...
        },
        {
            ...
            tech: ['HTML', 'CSS', 'JavaScript', 'Handlebars', 'Node', 'Express', 'Spotify-web-api-node', 'MySql', 'Sequelize', 'Bootstrap'],
